...
export default function DashboardPage() {
  ...
  const handleImportRepository = () => {
    ...
    const repoPlatform = document.querySelector('#repo-platform [data-value]')?.getAttribute('data-value') || 'Android';
    ...
    const repoName = repoUrl.split('/').pop()?.replace('.git', '') || `Repository ${newId}`;
    
    const project = {
      id: newId,
      name: repoName,
      description: `Imported from ${repoUrl} (${repoBranch} branch)`,
